...
const p = {};
const v = [];
const y = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
...
function S(n, l) {
  ...
  for (let u; l < n.__k.length; l++) if (null != (u = n.__k[l]) && null != u.__e) return u.__e;
...
function $() {
  for (let n, u, t, r, o, f, c, s = 1; i.length; )
    i.length > s && i.sort(e),
      (n = i.shift()),
      (s = i.length),
      n.__d &&
...
function j(n, l, u, t, i) {
  ...
  n: if ("style" === l)
    ...
    (r = l !== (l = l.replace(f, "$1"))),
      ...
      n.l || (n.l = {}),
      (n.l[l + r] = u),
      u ? (t ? (u.u = t.u) : ((u.u = c), n.addEventListener(l, r ? a : s, r))) : n.removeEventListener(l, r ? a : s, r);
  else {
    ...
    try {
      if (
        ...
        t.__c
          ...
          : (S ? (u.__c = h = new j(b, M)) : ((u.__c = h = new x(b, M)), (h.constructor = j), (h.render = D)),
            C?.sub(h),
            (h.props = b),
            h.state || (h.state = {}),
            (h.context = M),
        ...
        S &&
          ...
          (h.__s === h.state && (h.__s = d({}, h.__s)), d(h.__s, j.getDerivedStateFromProps(b, h.__s))),
        (v = h.props),
        (y = h.state),
        (h.__v = u),
        p)
      )
        S && null == j.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(),
      ...
      if (((h.context = M), (h.props = b), (h.__P = n), (h.__e = !1), (P = l.__r), (A = 0), S)) {
        for (
          h.state = h.__s, h.__d = !1, P?.(u), a = h.render(h.props, h.state, h.context), H = 0;
          H < h._sb.length;
          H++
        )
          h.__h.push(h._sb[H]);
        ...
        do {
          (h.__d = !1), P?.(u), (a = h.render(h.props, h.state, h.context)), (h.state = h.__s);
        } while (h.__d && ++A < 25);
      (h.state = h.__s),
...
function z(n, u, t) {
  for (let i = 0; i < t.length; i++) q(t[i], t[++i], t[++i]);
  l.__c?.(u, n),
    n.some((u) => {
      try {
        (n = u.__h),
...
function V(u, t, i, r, o, e, f, c, s) {
  ...
  if (null == u) {
    ...
    (u = document.createElementNS(o, x, k.is && k)), c && (l.__m?.(t, e), (c = !1)), (e = null);
  }
...
function B(n, u, t) {
  let i;
  let r;
  if ((l.unmount?.(n), (i = n.ref) && ((i.current && i.current !== n.__e) || q(i, null, u)), null != (i = n.__c))) {
...
function E(u, t, i) {
  ...
  t === document && (t = document.documentElement),
    l.__?.(u, t),
    (o = (r = "function" === typeof i) ? null : i?.__k || t.__k),
    (e = []),
    (f = []),
    O(
      t,
...
function J(l, u, t) {
  ...
  let e;
  const f = d({}, l.props);
  for (o in (l.type?.defaultProps && (e = l.type.defaultProps), u))
...
function K(n) {
  ...
  return (
    (l.__c = `__cC${h++}`), (l.__ = n), (l.Provider = l.__l = (l.Consumer = (n, l) => n.children(l)).contextType = l), l
  );
}
(n = v.slice),
  (l = {
    __e: (n, l, u, t) => {
      for (let i, r, o; (l = l.__); )
        if ((i = l.__c) && !i.__)
          try {
            if (
              ((r = i.constructor) &&
